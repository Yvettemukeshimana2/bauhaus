    ...
    <Card className="my-12 mx-auto max-w-7xl">
      <CardContent className="flex flex-col lg:flex-row items-start gap-8">
        ...
        <div className="lg:w-2/3 space-y-4">
          <h2 className="text-xl font-bold text-gray-800">Salton MUHETO</h2>
  ...
  <section className="py-16 bg-gray-50">
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
        <h2 className="text-xl font-bold text-yellow-500">MHS TEAM</h2>
        <p className="text-lg text-gray-600 mt-2">Meet Our Exceptional Team</p>
      </div>
